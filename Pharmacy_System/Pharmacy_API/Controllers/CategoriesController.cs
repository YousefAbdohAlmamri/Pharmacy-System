...
namespace Pharmacy_API.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        /*[HttpPost]
        [Consumes("multipart/form-data")]
        public async Task<ActionResult> PostCategory([FromForm] CategoryDto categoryDto)
        {
            ...
            string fileName = categoryDto.ImageFile.FileName;
            string filePath = Path.Combine(@"C:\Users\YOUSEF\source\repos\Pharmacy_System\Pharmacy_API\Images", fileName);
